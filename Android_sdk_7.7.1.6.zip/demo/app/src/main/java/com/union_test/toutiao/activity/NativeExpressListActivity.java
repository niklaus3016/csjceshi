...
public class NativeExpressListActivity extends Activity {
    ...
    private static class MyAdapter extends BaseAdapter {
        ...
        private static final int ITEM_VIEW_TYPE_VERTICAL_CREATIVE_EFFECT = 8; //创意素材
        ...
        public int getItemViewType(int position) {
            ...
            } else if(ad.getImageMode() == TTAdConstant.IMAGE_MODE_CREATIVE_EFFECT){
                return ITEM_VIEW_TYPE_CREATIVE_EFFECT;

            } else if(ad.getImageMode() == TTAdConstant.IMAGE_MODE_VERTICAL_CREATIVE_EFFECT){
