...
- `getPackageName()`：获取应用包名，固定为 `com.jianxuqingdan.app`
...
// 修改后
{ "employeeId": "8202", "deviceId": "csj_device_1735043770523_c89qhuhh4", "packageName": "com.jianxuqingdan.app" }
```
...
```json
{
  ...
  "packageName": "com.jianxuqingdan.app"
}
```
...
- `packageName`：应用包名，固定为 `com.jianxuqingdan.app`（必填）
